...
export default class Navigation extends Component{
  ...
  const typex = this.state.stype
    if(navvalue==2){
      ...
      return(
        <SearchView query={searchvalue} button={Buttonvalue} searchtype={typex}/>
  ...
  handleChange = (e) => {
    ...
    new SearchView({"query":e.target.value, "button":false, "searchtype":this.state.stype})
  }
  handleCategory = (e) => {
  ...
  handleSearch = (e) => {
    ...
    new SearchView({"query":this.state.value, "button":true, "searchtype":this.state.stype})
